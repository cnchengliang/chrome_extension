...
(function() {
    ...
    var c = b.Model.extend({
        ...
        getOption: function(a) {
            if (typeof chrome == "undefined") {
                ...
                parseInt(b.result.continue_enable) && a(b.result);
            });
        }
    });
    return new c;
    ...
    return new e;
}), define("views/oschina/feed", [ "jQuery", "Underscore", "Backbone", "libs/function.common" ], function(a, b, c) {
    var d = c.View.extend({
        opts: {
            port: 5500,
            scroll_tags: [],
        ...
        getContent: function() {
            _this = this;
            var a = parseInt(getParam("p"));
            isNaN(a) ? a = 1 : a += 1, _this._getContent(a);
        }
    });
    return new d;
