...
BG.common.menu = (function () 
{
	...
	function get_taobao_rate(data)
	{
		...
		{
			if(cur_action == 1 && data[0][0] == 'null')
			{
				is_seller = data[0][data.length-1] == 'null'?false:true;
			}
			if(cur_action == 2 && data[0][1] != 'null')
			{
				var xinyong = data[0][1].match(/\d/g).join("");
				if(is_seller)
				{
	...
	function taobao_rate_event(text)
	{
		...
		var port = 9080;
		var phantomjs_opt = {"option":{"route":"other.tool","type":"action","result_type":"notice","actions":[{"action":"auto_get_content","row_xpath":"//a[contains(descendant-or-self::*/text(),'店铺介绍')];//li[contains(descendant-or-self::*/text(),'买家信用')];//em[contains(descendant-or-self::*/text(),'好评率')];//div[@id='J_show_list']/ul/li[3]/table/tbody/tr[2]/td[2];//div[@id='J_show_list']/ul/li[4]/table/tbody/tr[2]/td[2];//div[@id='J_show_list']/ul/li[3]/table/tbody/tr[2]/td[3];//div[@id='J_show_list']/ul/li[4]/table/tbody/tr[2]/td[3];//div[@id='J_show_list']/ul/li[3]/table/tbody/tr[2]/td[4];//div[@id='J_show_list']/ul/li[4]/table/tbody/tr[2]/td[4]","cols":"","attr":"textContent;textContent;textContent;textContent;textContent;textContent;textContent;textContent;textContent"},{"action":"auto_click","xpath":"//a[contains(descendant-or-self::*/text(),'信用评价')]"}]}};
